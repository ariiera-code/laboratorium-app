<div x-data="{ show: false }" class="flex flex-col items-center transition">
  <div class="flex flex-col items-center relative">
    <button x-on:click="show = !show"
      ...
      <div class="flex items-center h-5 font-bold">
        {{ __('Hide Columns') }}
      </div>
    </button>
    <div x-show="show" x-on:click.away="show = false"
      ...
      <div class="flex flex-col w-full">
        @foreach ($this->columns as $index => $column)
          <div>
            <div
              class="@unless($column['hidden']) hidden @endif cursor-pointer w-full border-gray-800 border-b bg-gray-700 text-gray-500 hover:bg-blue-600 hover:text-white"
            ...
            <div class="@if ($column['hidden']) hidden @endif
              cursor-pointer w-full border-gray-800 border-b bg-gray-700 text-white hover:bg-red-600"
              wire:click="toggle({{ $index }})">
              <div class="relative flex w-full items-center p-2 group">
                <div class=" w-full items-center flex">
                  <div class="mx-2 leading-6">{{ $column['label'] }}</div>
