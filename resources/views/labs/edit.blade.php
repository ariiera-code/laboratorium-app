            ...
            <div class="overflow-hidden sm:rounded-md">
              ...
              <div class="border-t-4 border-indigo-400 bg-white rounded-lg sm:border-0">
                ...
                <div class="p-6">
                  ...
                  <div class="mb-2">
                    <select class="w-full border bg-indigo-50 rounded px-3 py-2 outline-none text-gray-700" disabled>
                      @foreach ($places as $place)
                        <option class="py-1" value="{{ $lab->place_id }}">{{ $lab->place->place_name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
